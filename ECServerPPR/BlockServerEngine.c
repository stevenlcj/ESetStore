...
void setECProperties(ECBlockServerEngine_t *ecBlockServerEnginePtr){
    ...
    ecBlockServerEnginePtr->pprPort = getIntValue(ecBlockServerEnginePtr->cfg, "chunkServer.PPRRecoveryPort");
    ...
    ecBlockServerEnginePtr->pprEnginePtr = createPPREngine(ecBlockServerEnginePtr->pprPort, ecBlockServerEnginePtr->recoveryBufNum, ecBlockServerEnginePtr->recoveryBufSize, (void *)ecBlockServerEnginePtr);
}
